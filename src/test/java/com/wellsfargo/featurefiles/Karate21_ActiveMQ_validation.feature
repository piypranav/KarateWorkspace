#http://10.0.0.60:8161/api/message?destination=queue%3A%2F%2Fasvnn.input
#http://10.0.0.60:8161/admin/index.jsp


Feature: JMS REST API - Test Suite 21
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://trainer.input"
    And header Connection = "Keep-Alive"
    And request "Hi, Karate - Welcome to JMS"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/trainer.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi, Karate - Welcome to JMS"
